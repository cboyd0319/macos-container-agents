...
pub(crate) const DEFAULT_FRAME_WIDTH: u32 = 192;
pub(crate) const DEFAULT_FRAME_HEIGHT: u32 = 208;
pub(crate) const DEFAULT_FRAME_COLUMNS: u32 = 8;
pub(crate) const DEFAULT_FRAME_ROWS: u32 = 9;
pub(crate) const SPRITESHEET_WIDTH: u32 = DEFAULT_FRAME_WIDTH * DEFAULT_FRAME_COLUMNS;
pub(crate) const SPRITESHEET_HEIGHT: u32 = DEFAULT_FRAME_HEIGHT * DEFAULT_FRAME_ROWS;
