...
use super::terminal_detection::Multiplexer;
use super::terminal_detection::TerminalInfo;
use super::terminal_detection::TerminalName;
use super::terminal_detection::terminal_info;
...
mod tests {
    ...
    // Codex used serial_test's `#[serial]` to serialize these env-var tests.
    // RunHaven does not vendor serial_test, so a process-global lock provides
    // the same mutual exclusion with no extra dependency.
