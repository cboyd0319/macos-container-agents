//! Source: openai/codex `codex-rs/protocol/src/user_input.rs`.
...
use crate::tui::codex_protocol::models::ImageDetail;
...
pub enum UserInput {
    Text {
        ...
        /// or persist rich input markers across history and resume without mutating
        /// the literal text.
        #[serde(default)]
    ...
    /// `Image` variant during request serialization.
    LocalImage {
...
impl TextElement {
    ...
    /// still refers to the same logical element within the new text.
