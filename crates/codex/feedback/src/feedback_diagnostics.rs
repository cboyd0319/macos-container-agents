...
impl FeedbackDiagnostics {
    ...
    pub fn collect_from_env() -> Self {
        // RunHaven keeps feedback diagnostics dormant until host environment
        // capture has a product boundary and redaction policy.
        Self::default()
    }
...
- Proxy environment variables are set and may affect connectivity.
  ...
  - all_proxy = socks5h://all-proxy.example.com:1080"#
    ...
    #[test]
    fn collect_from_env_is_disabled_for_runhaven() {
        assert_eq!(
