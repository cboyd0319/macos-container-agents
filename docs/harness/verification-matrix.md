...
| Run observability | Python code checks plus focused `tests/test_cli.py` run-record tests, git and non-git workspace cases, and manual `runhaven runs list/show/log/diff` checks |
